...
<body>
	<div class="navbar navbar-default" id="navbar">
		...
		<div class="navbar-container" id="navbar-container">
			<div class="navbar-header pull-left">
				<a href="javascript:void(0)" class="navbar-brand"> <small> <i class="icon-leaf"></i> 教务管理系统
				</small>
				</a>
				<!-- /.brand -->
			</div>
			...
			<div class="navbar-header pull-right" role="navigation">
				<ul class="nav ace-nav">
					...
					<li class="light-blue"><a data-toggle="dropdown" href="#" class="dropdown-toggle"> <img class="nav-user-photo"
							src="res/assets/avatars/user.jpg" alt="Jason's Photo" /> <span class="user-info"> <small>欢迎您:${user.userName }</small>
						</span> <i class="icon-caret-down"></i>
					</a>
						<ul class="user-menu pull-right dropdown-menu dropdown-yellow dropdown-caret dropdown-close">

							<li><a href="user.do" target="mainframe"> <i class="icon-user"></i> 个人资料
							</a></li>
		...
		<div class="main-container-inner">
			...
			<div class="sidebar" id="sidebar">
				...
				<ul class="nav nav-list">
					<li class="active"><a href="bootm.do" target="mainframe"> <i class="icon-dashboard"></i> <span class="menu-text">
								控制台 </span>
					</a></li>
					<c:forEach items="${menulist }" var="menu">
						<c:if test="${menu.prent_menu_id==0 }">
							<li><a href="javascript:void(0)" target="mainframe" class="dropdown-toggle"> <i class="icon-desktop"></i> <span
									class="menu-text"> ${menu.menu_name } </span> <b class="arrow icon-angle-down"></b>
							</a>

								<ul class="submenu">
									<c:forEach items="${menulist }" var="submenu">
										<c:if test="${menu.menu_id==submenu.prent_menu_id }">
											<li><a href="${submenu.menu_url }" target="mainframe"> <i class="icon-double-angle-right"></i>
													${submenu.menu_name }
											</a></li>
										</c:if>
									</c:forEach>
			...
			<div class="main-content" id="mains">
				<iframe id="mainframe" name="mainframe" src="user.do" style="width: 100%; border: 0px;"> </iframe>
			...
			<div class="ace-settings-container" id="ace-settings-container">
				...
				<div class="ace-settings-box" id="ace-settings-box">
					...
					<div>
						<input type="checkbox" class="ace ace-checkbox-2" id="ace-settings-navbar" /> <label class="lbl" for="ace-settings-navbar">
							固定导航条</label>
					</div>

					<div>
						<input type="checkbox" class="ace ace-checkbox-2" id="ace-settings-sidebar" /> <label class="lbl" for="ace-settings-sidebar">
							固定滑动条</label>
					</div>
	...
	<script src="res/assets/js/flot/jquery.flot.pie.min.js"></script>
	<script src="res/assets/js/flot/jquery.flot.resize.min.js"></script>
